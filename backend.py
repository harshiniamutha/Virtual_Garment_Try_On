...
def process_clothing_image():
    ...
    print("Uploaded file:", cloth_image.filename)
    print("Content type:", cloth_image.content_type)
    ...
    print("Received dress_category:", category)
    ...
    if gender == "Female":
        ...
        if size == "S":
            avatar_image_path = "kid_s_dress.jpg"
        elif size == "M":
            avatar_image_path = "kid_m_dress.jpg"
        elif size == "L":
            avatar_image_path = "Kid_l_dress.jpg"
    ...
    if not is_exactly_one_human(image_path, confidence_threshold=0.70) and category == "Upper-body" or category == "Lower-body":
        ...
        if gender == "Kid":
            if size == "S":
                avatar_image_path = "Kid_s.jpg"
            elif size == "M":
                avatar_image_path = "Kid_m.jpg"
            elif size == "L":
                avatar_image_path = "kid_l.jpg"
                   ...
                   # Add the best ROI to ROI_STORAGE
                    ...
                    for roi_key, roi_data in ROI_STORAGE.items():
                        ...
                        if category == "Lower-body":
                            ...
                            if clothing_type == "skirt" and gender == "Kid":
                                if size == "S":
                                    avatar_image_path = "kid_s_skirt.jpg"
                                elif size == "M":
                                    avatar_image_path = "kid_m_skirt.jpg"
                                elif size == "L":
                                    avatar_image_path = "Kid_l_skirt.jpg"
                        ...
                        if category == "Upper-body":
                          ...
                          print("Masked Output Image:", result[1])
                        if category == "Dress":
...
def display_output_image():
    ...
    return send_from_directory(UPLOAD_FOLDER, "result_image.jpg")
